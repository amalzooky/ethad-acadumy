...
class MemmbersConferenceCntroller extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.conferences.index', compact('vendors', 'categories'));
    }
    // groupSelected
    public function create()
    {
        $cities= Gavernement::all();
        return view('dashboard.conferences.create', compact('cities'));
    }
...
//            'image' =>  $request->image
        ...
        session()->flash('alert-success', 'تمت عمليةالتسجيل بنجاح! الرجاء الانتظار لارسال رقم العضويه');
