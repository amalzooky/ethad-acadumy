           ...
           <div class="row">
              <div class="col-md-12 col-lg-4">
                 ...
                 <div class="footer-awarad">
                    <img src="{{asset('frontend/images/icon/best.png')}}" alt="">
                    ...
                    <div class="col-md-12 col-lg-6">
                       <div class="footer-widget footer-left-widget">
                          ...
                          <ul>
                             ...
                             <li><a href="{{route('frontend.contact')}}">إتصل بنا</a></li>
                          </ul>
                          <ul>
                             <li><a href="{{route('frontend.gallery.categories')}}">معرض الصور</a></li>
                             <li><a href="#">قالو عنا</a></li>
                             <li><a href="{{route('frontend.honoraryboard')}}">لوحة الشرف</a></li>
                             <li><a href="{{route('frontend.teachers')}}">فريقنا</a></li>
                          </ul>
                       </div>
                       <!-- End Footer Widget -->
                    </div>
