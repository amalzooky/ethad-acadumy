            ...
            <div class="container">
                <div class="row">
                    <div class="col  mx-auto" style="">
                        ...
                        <form  class="card " method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body ">
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-6">
                                        <div class="form-group">
                                            <label class="form-label" for="card_stu">صوره الكارنيه <span class="form-required">*</span></label>
                                            <input name="card_stu" type="file" id="card_stu" class="form-control{{ $errors->has('card_stu') ? ' is-invalid' : '' }}"  required autofocus placeholder="@lang("frontend.username")">
