        ...
        <div class="row">
            <div class="col">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form action="{{route('student-news.update', $news->id)}}" method="POST" class="ajax">
                        @csrf
                        @method('patch')
                        <div class="form-group">
                            ...
                            <div class="input-icon">  
                                ...
                                <input required type="text" class="form-control" id="title" name="title" placeholder="@lang('dashboard.latestnews.title')"  value="{{$news->title}}" required autofocus>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-group select-image-from-media">
                                ...
                                <div class="input-group">
                                    <input  id="select-thumbnail" type="text" name="image" class="form-control" value="{{$news->image}}">
                                    <div class="btn-group ">
                        ...
                        <div class="form-group">
                            ...
                            <textarea placeholder="@lang('dashboard.latestnews.description')" class="form-control" name="body">{!! $news->body !!}</textarea>
                        </div>
                        <div class="form-group">
                                ...
                                <select class="form-control custom-select majors" name="major_id">
                                    ...
                                    <option value="{{$major->id}}" {{$major->id == $news->major_id ? 'selected' : ''}}>{{$major->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        <div class="form-group">
                            ...
                            <label class="custom-switch">
                                <input type="checkbox" name="is_active" id="is_active" {{$news->is_active ? 'checked' : ''}} class="custom-switch-input" value="1">
