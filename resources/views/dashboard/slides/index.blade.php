                ...
                <div class="card">
                  ...
                  <div class="card-header">
                    ...
                    <div class="card-options">
                        <a href="{{ route('admin.slides.create') }}"><button class="btn btn-success pull-left">اضافة شريحة <i class="fe fe-plus" aria-hidden="true"></i></button></a>
                    </div>
                        ...
                        <table class="table table-bordered table-striped hover datatable">
                            ...
                            <tbody>
                                @foreach ($slides as $index => $slide)
                                    <tr>
                                        <td>{{++$index}}</td>
                                        <td><img src="{{$slide->image}}" class="dt-img"></td>
