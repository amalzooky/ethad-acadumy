...
@section('title') @lang('dashboard.groups.create') @stop
        ...
        <div class="row">
            <div class="col">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form action="{{route('groups.store')}}" method="POST" class="ajax" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="@lang('dashboard.groups.name')"  value="{{old('name')}}" required autofocus>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="description" class="form-label">@lang('dashboard.groups.description')</label>
                            <textarea class="form-control" id="description" name="description" rows="5" placeholder="@lang('dashboard.groups.description')..." required></textarea>
                        </div>
                        <div class="form-group">
