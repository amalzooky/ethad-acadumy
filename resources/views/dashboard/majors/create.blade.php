...
@section('title') @lang('dashboard.header.major_create') @endsection
            ...
            <div class="col">
                <div class="card">
                  ...
                  <div class="card-header">
                    <h3 class="card-title">@lang('dashboard.header.major_create')</h3>
                  ...
                  <div class="card-body">
                    <form action="{{route('majors.store')}}" method="POST" class="ajax" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="@lang('dashboard.major.name')"  value="{{old('name')}}" required autofocus>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="description" class="form-label">@lang('dashboard.major.description')</label>
                            <textarea class="form-control" id="description" name="description" rows="5" placeholder="@lang('dashboard.major.description')..." required></textarea>
                        </div>
                        <div class="form-group">
{{--                            <div class="form-group select-image-from-media">--}}
{{--                                <label class="form-label">{{__('dashboard.major.image')}}</label>--}}
