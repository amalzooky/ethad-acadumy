            ...
            <div class="col">
                <div class="card">
                  ...
                  <div class="card-header">
                    <h3 class="card-title">@lang('dashboard.latestnews.edit')</h3>
                  ...
                  <div class="card-body">
                    <form action="{{route('latestnews.update',$latestnews->id)}}" method="POST" class="ajax">
                        @csrf
                        @method("patch")
                        <div class="form-group">
                            ...
                            <div class="input-icon">  
                                ...
                                <input value="{{$latestnews->title}}" required type="text" class="form-control" id="title" name="title" placeholder="@lang('dashboard.latestnews.title')"  value="{{old('title')}}" required autofocus>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-group select-image-from-media">
                                ...
                                <div class="input-group">
                                    <input required id="select-thumbnail" type="text" name="image" value="{{$latestnews->image}}" class="form-control">
                                    <div class="btn-group ">
                        ...
                        <div class="form-group">
                            ...
                            <textarea placeholder="@lang('dashboard.latestnews.description')" class="form-control" name="description">{{$latestnews->description}}</textarea>
                        </div>
                        <div class="form-group">
                            <div class="form-label">@lang('global.status')</div>
                            <label class="custom-switch">
                                <input @if($latestnews->is_active) {{'checked'}} @endif type="checkbox" name="is_active" id="is_active" class="custom-switch-input" value="1">
