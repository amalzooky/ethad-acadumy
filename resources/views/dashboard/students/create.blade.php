            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="facebook_url" class="form-label">@lang('global.facebook_url') (الطالب)</label>
                                <div class="input-icon">  
                                    <span class="input-icon-addon">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-icon">  
                                        ...
                                        <input type="url" class="form-control" id="facebook_parent" name="facebook_parent" placeholder="@lang('global.facebook_url')"  value="{{old('facebook_parent')}}">
                                    </div>
                                </div>
                            </div>
                        <div class="col-12 col-md-6">
