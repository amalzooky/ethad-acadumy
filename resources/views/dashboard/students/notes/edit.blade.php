                ...
                <div class="card">
                  ...
                  <div class="card-header">
                    ...
                    <div class="card-options">
                        <a href="{{route('student.notes', $note->student_id)}}"><button class="btn btn-info pull-left">ملاحظات الطالب <i class="fe fe-chevron-left" aria-hidden="true"></i></button></a>
                    </div>
                  </div>
                  <div class="card-body">
                    <form action="{{route('student.notes.update', $note->id)}}" method="POST" class="ajax">
                        @csrf
                        @method('patch')
