...
{{--                                    <td>{{($lecture->updated_at)}}</td>--}}
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="javascript:void(0)" data-url="{{route('lectures.destroy', $lecture->id)}}" data-areyousure="هل أنت متأكد ؟" title="@lang('dashboard.lectures.delete')" class="btn btn-danger btn-sm dt-btn-delete"><i class="fe fe-trash-2" aria-hidden="true"></i></a>
