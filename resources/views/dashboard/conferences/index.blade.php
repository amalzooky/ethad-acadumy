                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-options">
                            ...
                            <a href="{{ route('certificate.create') }}"><button class="btn btn-success pull-left">انشاء شهاده <i class="fe fe-plus" aria-hidden="true"></i></button></a>
                        </div>
                                ...
                                @foreach($certif as  $cert)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{route('certificate.edit', $cert->id)}}" title="@lang('dashboard.lecture.edit')" class="btn btn-primary btn-sm mb-2 mb-sm-0"><i class="fe fe-edit" aria-hidden="true"></i></a>
                                            <a href="javascript:void(0)" data-url="{{route('certificate.destroy', $cert->id)}}" data-areyousure="هل أنت متأكد ؟" title="@lang('dashboard.lectures.delete')" class="btn btn-danger btn-sm dt-btn-delete"><i class="fe fe-trash-2" aria-hidden="true"></i></a>


                                         <a href="{{route('certificate.show', $cert->id)}}" >عرض</a>
