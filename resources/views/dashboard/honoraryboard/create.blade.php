...
@section('title') @lang('dashboard.honoraryboards.create') @stop
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form action="{{route('honoraryboards.store')}}" method="POST" class="ajax" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            ...
                            <div class="input-icon">  
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="@lang('dashboard.honoraryboards.name')"  value="{{old('name')}}" required autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-icon">  
                                ...
                                <input  type="text" class="form-control" id="university" name="university" placeholder="@lang('dashboard.honoraryboards.university')"  value="{{old('university')}}" required >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-icon">  
                                ...
                                <input  type="text" class="form-control" id="major" name="major" placeholder="@lang('dashboard.header.major')"  value="{{old('major')}}" required >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-icon">  
                                ...
                                <input type="number" class="form-control" id="marker" name="marker" placeholder="@lang('dashboard.marker')"  value="{{old('marker')}}" required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-icon">  
                                ...
                                <input type="number" class="form-control" id="year" name="year" placeholder="@lang('dashboard.year_un')"  value="{{old('year')}}" required>
                            </div>
                        </div>
                        <div class="form-group">
                                ...
                                <div class="input-icon">  
                                    ...
                                    <input type="url" class="form-control" id="interview_url" name="interview_url" placeholder="@lang('dashboard.honoraryboards.interview_url')"  value="{{old('interview_url')}}">
                                </div>
                            </div>
                        <div class="form-group">
