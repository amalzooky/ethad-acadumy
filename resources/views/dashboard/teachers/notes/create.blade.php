                ...
                <div class="card">
                  ...
                  <div class="card-header">
                    ...
                    <div class="card-options">
                        <a href="{{ route('teachers.notes', $id) }}"><button class="btn btn-info pull-left">ملاحظات المعلم <i class="fe fe-chevron-left" aria-hidden="true"></i></button></a>
                    </div>
                  </div>
                  <div class="card-body">
                    <form action="{{route('teachers.notes.store')}}" method="POST" class="ajax">
                        @csrf
