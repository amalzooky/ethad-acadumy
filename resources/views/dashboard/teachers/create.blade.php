...
@section('title') @lang('dashboard.header.teacher_create') @stop

@section('content')

<div class="container profile">
    <form action="{{route('teachers.store')}}" method="post" class="ajax" enctype="multipart/form-data">
        @csrf
        <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="text" class="form-control" id="job_title" name="job_title" placeholder="الدور الوظيفي" required >
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
