...
@section('title') تعديل معلومات التصنيف @stop
            ...
            <div class="col-md-12 col-sm-12">
                <div class="card">
                  ...
                  <div class="card-header">
                    <h3 class="card-title">تعديل معلومات التصنيف</h3>
                  ...
                  <div class="card-body">
                    <form action="{{route('gallery-categories.update', $category->id)}}" method="POST" class="ajax" enctype="multipart/form-data">
                        @method('patch')
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$category->name}}" id="name" name="name" placeholder="إسم التصنيف"  required autofocus>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" value="{{$category->date}}" id="date" name="date" placeholder="تاريخ المناسبة"  required >
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="location" class="form-label">مدينة المناسبة</label>
                                    <input type="text" class="form-control" value="{{$category->location}}" id="location" name="location" placeholder="مدينة المناسبة"  required >
                                </div>
                            </div>
                        </div>
