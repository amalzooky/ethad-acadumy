        ...
        <div class="row d-flex align-items-center">
            ...
            <div class="col-md-5">
                <div class="d-flex justify-content-md-end justify-content-between">
                    ...
                    <div class="login">
                        <a href="{{route('login')}}" data-toggle="modal" data-target="#login-modal" class="login-btn"><i class="fa fa-sign-in"></i><span class="d-none d-md-inline-block">تسجيل </span></a>
                    ...
                    <nav role="navigation">
                        <ul class="nav-list" id="collapse" >
                            ...
                            <li class=" nav-list__item dropdown">
                                ...
                                <ul class="dropdown-menu ">
                                    <li class="nav-list__item"><a class='nav-link'  href="{{route('front.Qualityassura')}}">أهداف وحده ضمان الجوده</a> </li>
                                    <li class="nav-list__item"><a class='nav-link' href="{{route('front.questionnaire')}}">أستبيان</a></li>
                                    <li class="nav-list__item"><a class='nav-link' href="{{route('front.complaint')}}">تقديم شكوي</a></li>
                                </ul>
                            </li>
