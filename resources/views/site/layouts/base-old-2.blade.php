	...
	<div class="banner-agile">
		...
		<div class="banner-text-posi-w3ls">
			<div class="banner-text-whtree">
				...
				<a href="{{route('front.about')}}" class="button-agiles text-capitalize text-white mt-sm-5 mt-4">المزيد</a>
			</div>
		</div>
				...
				<div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
					<ul class="navbar-nav justify-content-center" style='direction: rtl;'>
						<li class="nav-item active">
							<a class="nav-link text-white" href="{{route('front.index')}}">الرئيسية
								<span class="sr-only">(current)</span>
							</a>
						</li>
						<li class="nav-item">
							<a class="nav-link text-white" href="{{route('front.about')}}">عنا</a>
						</li>
                        ...
                        <li class="nav-item">
							<a class="nav-link text-white" href="{{route('front.views')}}">قالوا عنا</a>
						</li>
						<li class="nav-item">
							<a class="nav-link text-white" href="{{route('front.gallery.categories')}}">معرض الصور</a>
						</li>
						<li class="nav-item">
							<a class="nav-link text-white" href="{{route('front.honoraryboard')}}">لوحة الشرف</a>
                        </li>
                        <li class="nav-item">
							<a class="nav-link text-white" href="{{route('front.contact')}}">تواصل معنا</a>
                        </li>
